...
public class SecretLevel extends JPanel implements ActionListener, KeyListener{
	...
	public SecretLevel(int damage2, int health2, String state, String state2, String state3, String state4, String powered) {
		...
		Thread t = new Thread() 
        {
			...
			public void run()
			{
				...
				{  	
					...
					if (i5 % 3 == 0) {
						method(new File("sound/freeze.WAV"));
						i5++;
					}
					...
					if (x > 525 && conditionN) {
						...
						if (health == 750) {
							pow = true;
							pass = "image/icetankR.png";
							pass2 = "image/icetankR2.png";
							pass3 = "image/icetankL.png";
							pass4 = "image/icetankL2.png";
						}
	...
	public void keyPressed(KeyEvent e) 
	{
		...
		if (code == KeyEvent.VK_RIGHT) 
		{
			...
			if (i == 0 && pow) 
			{
				imageReader("image/icetankR.png");
			}
			
			else if (i == 1 && pow)
			{
				imageReader("image/icetankR2.png");
			}
		...
		if (code == KeyEvent.VK_LEFT) 
		{
			...
			if (i == 0 && pow) 
			{
				imageReader("image/icetankL.png");
			}
			
			else if (i == 1 && pow)
			{
				imageReader("image/icetankL2.png");
			}
	...
	{   
	   ...
	   if (pass.equals("image/galavanizer.png")
		   ...
		   g.drawImage(image, x - 25, y - 150, this);
	   }
	  ...
	  // en2.paintComponent(g);
	   ...
	   for (Rectangle o : obs) 
	   {
		   ...
		   g.drawImage(scaleImage(o.width, o.height, "image/iceblock.png"), o.x, o.y, null);
	   }
